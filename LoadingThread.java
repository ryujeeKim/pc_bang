...
public class LoadingThread extends JFrame {
    ...
    public LoadingThread() {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                dispose(); // 현재 클래스 종료
                main.showFrameTest0(); // PCBangTimer 클래스 실행
            }
        }, 5000);
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(LoadingThread::new);
    }
}